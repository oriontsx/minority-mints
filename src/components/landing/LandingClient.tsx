        ...
        <div className="relative z-10 mx-auto flex min-h-screen max-w-md flex-col items-center justify-center px-6 text-center">
          ...
          >
            ...
            <motion.div
              ...
              className="surface mt-10 rounded-3xl p-6 text-left"
            >
              ...
              <button
                type="button"
                className="group flex w-full items-center justify-between rounded-full bg-white px-6 py-3 transition-all hover:scale-[1.02] hover:shadow-[0_0_30px_rgba(255,255,255,0.25)]"
                style={{ fontFamily: "var(--font-sans)" }}
              >
                <span className="text-base font-semibold" style={{ color: "#0a0400" }}>
                  Connect Wallet
                </span>
